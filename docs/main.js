...
},{"./RaceMatch.js":3}],3:[function(require,module,exports){
'use strict';
...
module.exports = function (group) {
	...
	this.getHeatDrivers = function (heatId, display) {
		...
		var heatDrivers = [this.getDriver(heat[0]), this.getDriver(heat[1]), this.getDriver(heat[2]), this.getDriver(heat[3])];
...
},{"./RaceDriver.js":1}],4:[function(require,module,exports){
'use strict';
...
var myApp = new Vue({
	...
	methods: {
		...
		setDrivers: function setDrivers(count) {
...
},{"./lib/RaceDriver.js":1,"./lib/RaceEvent.js":2,"./lib/RaceMatch.js":3,"vue":6}],5:[function(require,module,exports){

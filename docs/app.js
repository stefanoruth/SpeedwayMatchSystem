...
var RaceDriver = __webpack_require__(1);
...
module.exports = function (group) {
	...
	this.setDrivers = function (drivers) {
		...
		} else if ((typeof drivers === 'undefined' ? 'undefined' : _typeof(drivers)) === 'object') {
			if (drivers.length < 4) {
	...
	this.getHeatDrivers = function (heatId) {
		...
		return [this.getDriver(heat[0]).number, this.getDriver(heat[1]).number, this.getDriver(heat[2]).number, this.getDriver(heat[3]).number];
	};
};
...
var RaceMatch = __webpack_require__(0);
var RaceDriver = __webpack_require__(1);
var RaceEvent = __webpack_require__(6);
...
new Vue({
	...
	computed: {
		sortedDrivers: function sortedDrivers() {
	...
	methods: {
		...
		clearDrivers: function clearDrivers() {
		...
		heatDrivers: function heatDrivers(group, round) {
